        ...
        return (
            <Suspense fallback={(
                <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-[100] flex flex-col items-end pointer-events-auto font-mono text-sm">
                    <button
                        className="group flex items-center justify-center w-11 h-11 md:w-14 md:h-14 bg-charcoal border border-neutral-800 text-garnet shadow-lg hover:bg-neutral-900 transition-all rounded-full"
